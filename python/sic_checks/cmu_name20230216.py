# -*- coding: utf-8 -*-
"""
Created on Thu Feb 16 15:31:15 2023

@author: stf45

This script was created to find SIC frequencies from CMU name search results in
...
for c, (sic_chunk,company_chunk) in enumerate(readers):
    ...
    out_df.to_csv(r"C:\\Users\\stf45\\Documents\\NETS\\Processing/scratch/cmu_name20230216.txt", sep="\t", header=header, mode='a', index=False)
...
#%%
results = pd.read_csv(r"C:\\Users\\stf45\\Documents\\NETS\\Processing/scratch/cmu_name20230216.txt", sep = '\t', dtype={'DunsNumber':str,'ZipCode':str,'SIC19':int},  header=0)
...
#%%
with pd.ExcelWriter(r'C:\Users\stf45\Documents\NETS\Processing\scratch\cmu_name20230216.xlsx') as writer:
    results.to_excel(writer, "cmu name search results", index=False)
