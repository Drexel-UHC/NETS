# -*- coding: utf-8 -*-
"""
Created on Mon Aug 15 10:37:39 2022

@author: stf45

This script grabs all records in the NETS dataset with SIC 53310000 
("variety"/dollar stores) in the year 2019. It is used as a preliminary check on records
with this SIC code.
...
for c, (sic_chunk, emp_chunk, sales_chunk, company_chunk, misc_chunk) in enumerate(readers):
    ...
    sic_check_wide.to_csv(r"C:\\Users\\stf45\\Documents\\NETS\\Processing/scratch/dollar_store_sic20220815.txt", sep="\t", header=header, mode='a', index=False)
...
dlrstore = pd.read_csv(r"C:\\Users\\stf45\\Documents\\NETS\\Processing/scratch/dollar_store_sic20220815.txt", sep = '\t', dtype={"DunsNumber": str},  header=0)

#%% WRITE TABLE TO EXCEL

with pd.ExcelWriter(r'C:\Users\stf45\Documents\NETS\Processing\scratch\dollar_store_sic20220815.xlsx') as writer:
    dlrstore.to_excel(writer, "records w dollar store sic", index=False)
