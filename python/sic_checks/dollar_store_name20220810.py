...
for c, (sic_chunk, emp_chunk, sales_chunk, company_chunk, misc_chunk) in enumerate(readers):
    ...
    out_df.to_csv(r"C:\\Users\\stf45\\Documents\\NETS\\Processing/scratch/dollar_store_regex20220810.txt", sep="\t", header=header, mode='a', index=False)
...
with pd.ExcelWriter(r'C:\Users\stf45\Documents\NETS\Processing\scratch\dollar_store_regex20220810.xlsx') as writer:
