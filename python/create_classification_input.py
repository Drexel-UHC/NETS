...
import time
import json
from NETS_functions import merge_sic_emp_sales, normal_to_long, classify
...
for c, (sic_chunk, emp_chunk, sales_chunk, company_chunk) in enumerate(readers):
    ...
    long_chunk = normal_to_long(classification_wide, header)
    classify(long_chunk, config, header)
