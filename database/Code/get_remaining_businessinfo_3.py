# -*- coding: utf-8 -*-
"""
Created on Mon Aug 14 14:45:31 2023
...
for i, chunk in enumerate(fullfile):
    ...
    loadfile.to_csv(r'D:\NETS\NETS_2019\ProcessedData\BusinessInfoRemaining20230817.txt', sep='\t', index=False, mode='a', header=header)   
...
check = pd.read_csv(r'D:\NETS\NETS_2019\ProcessedData\BusinessInfoRemaining20230817.txt', sep='\t')
