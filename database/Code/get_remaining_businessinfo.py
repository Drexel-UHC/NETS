# -*- coding: utf-8 -*-
"""
Created on Fri Aug 11 08:47:54 2023
...
for i, chunk in enumerate(fullfile):
    ...
    loadfile.to_csv(r'D:\NETS\NETS_2019\ProcessedData\BusinessInfoRemaining20230811.txt', sep='\t', index=False, mode='a', header=header)   
